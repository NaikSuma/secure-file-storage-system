...
import com.mit.SecureFileStorage.auth.dto.UserToken;
import com.mit.SecureFileStorage.auth.entity.User;
import com.mit.SecureFileStorage.auth.services.RegistrationService;
...
public class AuthController {
    ...
    public ResponseEntity<?> verifyCode(@RequestBody Map<String, String> map) {
        ...
        if (user != null && user.getVerificationCode() != null && code != null &&
